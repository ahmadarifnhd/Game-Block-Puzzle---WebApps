...
const update_score = () => {
    document.querySelector("#score").innerHTML = "Skor : " + score
    for (bonus of Object.keys(bonuses.total)) {
        ...
        if (tilesprops.can_place == true) {
            ...
            setTimeout(() => {
                if (check_moves() == 0 && animation_done("tile")) {
                    ...
                    document.querySelector("#end-box").style.opacity = "1"
                    document.querySelector("#end-box").style.pointerEvents = "auto"
                    document.querySelector("#reset-box").style.display = "none"
                    document.querySelector("#reset-box").style.opacity = "0"
                    document.querySelector("#reset-box").style.pointerEvents = "none"
